		...
		<div class='row d-flex flex-column col-12 align-items-center justify-content-center'>
			...
			<form class='col-lg-4 col-md-5 col-12 row rounded bg-light shadow m-2 justify-content-center p-2' method='POST' action='controller/log/inscription.php' enctype='multipart/form-data'>
				...
				<div class='d-flex justify-content-between col-12'>
					...
					<div class='input-group row col-6 justify-content-center mt-1 p-0 '>
						<div class='col-12 row d-flex' >
							<label class='col-7 m-0 p-0'>Promo</label>
							<select class="form-control form-control-md col-12" name='promo'>
				...
				<div class='col-12 d-flex justify-content-center m-1 p-1'>
					<button class='btn btn-primary m-2' id='inscr-btn' name='inscr-submit' type='submit'>S'inscrire</button>
