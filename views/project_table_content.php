...
<tr style='font-size:1.2em;'>
	...
	<td class='text-center'><?=$project["chrono"]?></td>
	...
	<td class=' '><img src='medias/avatars/1.jpg' class='rounded-circle' height="30"/><img src='medias/add.png' class='rounded-circle' height='30'/></td>
</tr>
